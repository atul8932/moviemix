    ...
    <div className="login-container">
      ...
      <header className="login-header">
        ...
        <nav className="header-links">
          <Link className="btn btn-text" to="/">Home</Link>
          <Link className="btn btn-text" to="/bollywood?section=bollywood">Bollywood</Link>
          <Link className="btn btn-text" to="/bollywood?section=hollywood">Hollywood</Link>
          <Link className="btn btn-text" to="/bollywood?section=ott-en">OTT Originals (EN)</Link>
          <Link className="btn btn-text" to="/bollywood?section=ott-hi">OTT Originals (HI)</Link>
        </nav>
      </header>
      ...
      <main className="login-main">
        <div className="login-card">
          <div className="login-header-content">
            ...
            <p>Sign in to access your movie downloads</p>
          </div>
          ...
          <div className="login-footer">
            <p>Don't have an account? <Link to="/" className="link-primary">Back to Home</Link></p>
          </div>
        </div>
      </main>
    </div>
